...
<html lang="fr">
    <head>        
        ...
        <link rel="shortcut icon" type="image/jpeg" href="<?php echo Chemins::IMAGES . 'ziknco_title.jpg'; ?>">
        <!--[if lt IE 9]>
    ...
    <body>
        <header>
            ...
            <!-- Images En-tête -->
            <a href="index.php"><img src="<?php echo Chemins::IMAGES.'ziknco.jpg'; ?>" alt="ZiKnCo" title="Revenir à l'accueil"/></a>
